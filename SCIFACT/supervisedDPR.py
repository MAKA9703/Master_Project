...
train_samples = retriever.load_train(new_corpus, dict_tr_q, new_train_qrels)
...
model_save_path = os.path.join(pathlib.Path('./dpr_models').parent.absolute(), "dpr_models/output_norm", "{}-v1-{}".format(model_name, "SCI-FACT"))
