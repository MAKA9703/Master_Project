...
train_q3 = train_q
train_q3['query'] = train_q3['query'] + " " + train_q1['query'] + " " + train_q2['query']
...
train_samples = retriever.load_train(new_corpus, dict_tr_q3, new_train_qrels)
...
model_save_path = os.path.join(pathlib.Path('./dpr_models').parent.absolute(), "dpr_models/output_c2", "{}-v1-{}".format(model_name, "SCI-FACT"))
