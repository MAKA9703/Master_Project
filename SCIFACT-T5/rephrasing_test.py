...
#train data
df_train = pd.read_csv('./scifact/test.csv', sep='\t', dtype=str)
df_train2 = df_train[['qid', 'query']]
df_train2.to_csv('.scifact/temp_test_queries.csv', sep = '\t', index=False, header=False)
train_query = pt.io.read_topics('./scifact/temp_test_queries.csv', format='singleline')
...
#Save files
train_new_queries1.to_csv('./scifact/rephrase/T5_test_query1.csv', sep='\t', index = False, header = False)
train_new_queries2.to_csv('./scifact/rephrase/T5_test_query2.csv', sep='\t', index = False, header = False)
train_new_queries3.to_csv('./scifact/rephrase/T5_test_query3.csv', sep='\t', index = False, header = False)
