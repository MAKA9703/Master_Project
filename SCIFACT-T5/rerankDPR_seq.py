...
store_res(test_alt3, retrieved_passages_seq, "seq_alt3")
store_res(test_alt3, retrieved_passages_seq_alt3, "seq_alt3_alt3")
store_res(test_alt3, retrieved_passages_seq_comb3, "seq_comb3_alt3")

store_res(test_comb3, retrieved_passages_seq, "seq_comb3")
store_res(test_comb3, retrieved_passages_seq_alt3, "seq_alt3_comb3")
store_res(test_comb3, retrieved_passages_seq_comb3, "seq_comb3_comb3")
